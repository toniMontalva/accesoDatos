...
namespace PlaceMyBetAPI.Models
{
    public class ApuestasRepository
    {
        ...
        internal void Save(Apuesta apuesta)
        {
            ...
            command.CommandText = "INSERT into apuestas(id, cuota, cantidad, tipo, id_usuario) values ('" + apuesta.ApuestaId + "','" + apuesta.Cuota + "','" + apuesta.Cantidad +
                "','" + apuesta.Tipo + "','" + apuesta.UsuarioId + "')";
